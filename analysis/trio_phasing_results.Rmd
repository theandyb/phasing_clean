...
```{r warning=FALSE}
# Beagle
autosomes <- df_total %>% filter(chrom < 23) %>% pull(Beagle)
chrX <- df_total %>% filter(chrom == 23) %>% pull(Beagle)
t.test(autosomes, chrX) %>% broom::tidy()

# Eagle
autosomes <- df_total %>% filter(chrom < 23) %>% pull(Eagle)
chrX <- df_total %>% filter(chrom == 23) %>% pull(Eagle)
t.test(autosomes, chrX) %>% broom::tidy()

# SHAPEIT
autosomes <- df_total %>% filter(chrom < 23) %>% pull(SHAPEIT)
chrX <- df_total %>% filter(chrom == 23) %>% pull(SHAPEIT)
t.test(autosomes, chrX) %>% broom::tidy()
...
```{r warning=FALSE}
chrom <- 1 
plot_total_rate(df_switch_trio[[22]], "Beagle", "Eagle", "SUPER", chrom)
plot_total_rate(df_switch_trio[[22]], "Beagle", "SHAPEIT", "SUPER", chrom)
plot_total_rate(df_switch_trio[[22]], "SHAPEIT", "Eagle", "SUPER", chrom)

cross_meth_plot(df_switch_trio[[22]], "Total Errors", plot_total_rate, "SUPER", as.character(chrom))
```
...
```{r warning=FALSE}
chrom <- 1
plot_switches(df_switch_trio[[1]], "Beagle", "Eagle", "SUPER", chrom)
plot_switches(df_switch_trio[[1]], "Beagle", "SHAPEIT", "SUPER", chrom)
plot_switches(df_switch_trio[[1]], "SHAPEIT", "Eagle", "SUPER", chrom)

table_switches(df_switch_trio[[1]], "SUPER")

cross_meth_plot(df_switch_trio[[1]], "Switches", plot_switches, "SUPER", as.character(chrom))
```
...
```{r warning=FALSE}
chrom <- 1
plot_switch_rate(df_switch_trio[[1]], "Beagle", "Eagle", "SUPER", chrom)
plot_switch_rate(df_switch_trio[[1]], "Beagle", "SHAPEIT", "SUPER", chrom)
plot_switch_rate(df_switch_trio[[1]], "SHAPEIT", "Eagle", "SUPER", chrom)
cross_meth_plot(df_switch_trio[[1]], "Switches", plot_switch_rate, "SUPER", as.character(chrom))
```
...
```{r warning=FALSE}
chrom <- 1
plot_flips(df_switch_trio[[1]], "Beagle", "Eagle", "SUPER", chrom)
plot_flips(df_switch_trio[[1]], "Beagle", "SHAPEIT", "SUPER", chrom)
plot_flips(df_switch_trio[[1]], "SHAPEIT", "Eagle", "SUPER", chrom)

table_flip(df_switch_trio[[1]], "SUPER")

cross_meth_plot(df_switch_trio[[1]], "Flips", plot_flips, "SUPER", as.character(chrom))
```
