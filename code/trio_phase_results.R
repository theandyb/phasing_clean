...
for(chrom in 1:22){
  ...
  n_het_cpg_df <- read_tsv(paste0(config_obj$base_dir,"/output/trio_phase_", chrom, "/het_cpg_count.tsv"),
  ...
  write_csv(df_trio, paste0(config_obj$base_dir,"/output/trio_phase_", chrom, "/switch_errors/summary.csv"))
}
