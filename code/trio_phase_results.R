...
het_loc_dir <- paste0(config_obj$base_dir,"/",config_obj$trio_result_dir,"/het_loc/")
...
n_het_cpg_df <- read_tsv(paste0(config_obj$base_dir,"/",config_obj$trio_result_dir, "/het_cpg_count.tsv"),
