...
#SBATCH -e /net/snowwhite/home/beckandy/research/phasing_clean/output/trio_phase_15/slurm/tripleHet.%A.%a.err
#SBATCH --output=/net/snowwhite/home/beckandy/research/phasing_clean/output/trio_phase_15/slurm/tripleHet.%A.%a.out
...
include_dir="${base_dir}/data/1kgp/chr15/triple_het/trio_lists"
out_dir="${base_dir}/data/1kgp/chr15/triple_het"
